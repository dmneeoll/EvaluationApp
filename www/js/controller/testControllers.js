    ...
    .controller('TestPageCtrl', function ($scope, $rootScope, $state, $ionicHistory, $ionicPopup,
        ...
        $scope.OpenOutLink = function () {
            try {
                ...
                var url = 'https://mp.weixin.qq.com/s/EqfaiJNJKvNRHgVRhFbnMQ';
        ...
        $scope.doDownload=function(){
            try {
                //var url = 'https://zhmobile.flextronics.com/EvaluationApp/Upload/Other/MechMCQR.png';
                var url = 'https://zhmobile.flextronics.com/EvaluationApp/Upload/Other/test.pdf';
                //UrlServices.downloadImage(url);
                //externalLinksService.openUr(url);
